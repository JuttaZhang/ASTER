...
# vgg16,cifar100 bayesion测试

# Training settings
parser = argparse.ArgumentParser(description='PyTorch Slimming CIFAR training')
parser.add_argument('--depth', type=int, default=16,
                    help='model (default: vgg16)')
...
parser.add_argument('--pec', type=float, default=0.5,
                    help='衡量tradeoff的比例')
parser.add_argument('--lb', type=float, default=0.45,
...
def train_evaluate(parameterization):
    ...
    filepath = './resultsvgg16_100/{}_{}_{}_{}'.format(args.depth, init_thres, x,args.num)
    ...
    for epoch in range(0, args.epochs):
        ...
        if (epoch + 1) % 5 == 0 and flag and upper_flag and not chosen_flag:
            ...
            f1 = open("record/delta_vgg16_cifar100_{}_{}.csv".format(args.num,(epoch+1)/5), "w")
...
best_parameters, values, experiment, model = optimize(
    parameters=[
        {"name": "init_thres", "type": "range", "bounds": [1e-10, 0.1], "log_scale": True},
        {"name": "x", "type": "range", "bounds": [0.00001, 0.1]},
    ],
