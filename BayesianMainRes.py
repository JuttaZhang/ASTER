...
# resnet56,resnet110,cifar10 bayesion测试
...
parser.add_argument('--exp_flops', type=float, default=0.5,
...
def train_evaluate(parameterization):
    ...
    filepath = './resultsRescifar10/{}_{}_{}_{}_{}'.format(args.depth, init_thres, x, args.num, args.exp_flops)
    ...
    for epoch in range(0, args.epochs):
        ...
        if (epoch + 1) % 5 == 0 and flag and upper_flag and not chosen_flag:
            ...
            f1 = open("record/delta_resnet{}_cifar10_{}_{}.csv".format(args.depth, args.num, (epoch + 1) / 5), "w")
