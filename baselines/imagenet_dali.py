...
if __name__ == '__main__':
    train_loader = get_imagenet_iter_dali(type='train', image_dir='/home/yuyao/datasets/imagenet', batch_size=256,
                                          num_threads=25, crop=224, device_id=0, num_gpus=1)
    print('start iterate')
    start = time.time()
    ...
    train_loader = get_imagenet_iter_torch(type='train', image_dir='/home/yuyao/datasets/imagenet', batch_size=256,
                                           num_threads=25, crop=224, device_id=0, num_gpus=1)
    print('start iterate')
    start = time.time()
    for i, data in enumerate(train_loader):
